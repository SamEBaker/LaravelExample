    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        <label for="salary" class="block text-sm font-medium leading-6 text-white">Budget</label>
                        <div class="mt-2">
                            <div
                            ...
                            >
                                <input
                                    ...
                                    placeholder="Blah job description completed X/X/XXXX"
                                    value="{{ $job->salary }}"
                                    required>
                            </div>
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            ...
            <div class="flex items-center gap-x-6">
                ...
                <div>
                    <button type="submit"
                            class="rounded-md bg-orange-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">
                        Update
                    </button>
                </div>
            </div>
